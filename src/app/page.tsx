...
export default function LoginPage() {
  ...
  return (
    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-zinc-950">
      ...
      <div className="flex flex-col items-center gap-6 p-8 rounded-2xl bg-zinc-900 shadow-xl">

        <h1 className="text-3xl font-bold text-white">PDF Audiobook</h1>

        <p className="text-zinc-400 text-sm">Sign in to access the library</p>
